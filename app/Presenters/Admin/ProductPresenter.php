...
<div class="form-group">
        <label class="col-sm-2 control-label" for="">产品分类</label>
        <div class="col-sm-10">
<select id="top" class="chosen-select"  name="data[cate_id]"><option value="0">请选择</option>
Eof;
            $topSel = $subSel = '';
            foreach ($categorys as $key => $val) {
                ...
                if (isset($val['sub'])) {
                    $subSel .= '<select id="sub" class="chosen-select" name="data[cate_id]"><option value="0">请选择</option>';
