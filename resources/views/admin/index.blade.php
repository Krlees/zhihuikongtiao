...
<head>
    ...
    <link href="{{asset('hplus/css/style.css?v=4.1.0')}}" rel="stylesheet">
</head>
...
<!-- 自定义js -->
<script src="{{asset('hplus/js/hplus.js?v=4.1.0')}}"></script>
<script type="text/javascript" src="{{asset('hplus/js/contabs.js')}}"></script>
